...
class Galeri extends Render_Controller
{
	...
	public function insert()
	{
		...
		$id_gdrive = $this->input->post("id_gdrive");
		$foto_id_gdrive = $this->input->post("foto_id_gdrive");
		$status = $this->input->post("status");
		$keterangan = $this->input->post("keterangan");
		$user_id = $this->id;
		$result = $this->model->insert($user_id, $nama, $slug, $foto, $id_gdrive, $foto_id_gdrive, $keterangan, $status);
	...
	public function update()
	{
		...
		$keterangan = $this->input->post("keterangan");
		$user_id = $this->id;
		$result = $this->model->update($id, $user_id, $nama, $slug, $foto, $id_gdrive, $foto_id_gdrive, $keterangan, $status);
		$code = $result ? 200 : 500;
		$this->output_json(["data" => $result], $code);
	}
